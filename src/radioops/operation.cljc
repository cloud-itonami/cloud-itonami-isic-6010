(ns radioops.operation
  ...
  proposal is ALWAYS routed through the BroadcastOpsGovernor (:govern)
  ...
  human operator/program director. The approver resumes with
...
(defn build
  ...
  `radioops.store/Store`).
  opts:
    :advisor      -- a `radioops.advisor/Advisor` (default: mock-advisor)
  ...
  (-> (g/state-graph
      ...
      ;; BroadcastOpsGovernor -- independent censor (separate system than the advisor).
      (g/add-node :govern
