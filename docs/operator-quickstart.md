# Operator Quickstart — Community Radio Broadcasting Operations

Shortest path from clone to a verified local dry-run for **ISIC 6010** (`cloud-itonami-isic-6010`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6010.git
cd cloud-itonami-isic-6010
```
...
- Blueprint governor key: `radio-broadcast-governor`
- Likely source path: `src/**/radio-broadcast-governor.cljc`
